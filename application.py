...
private_key_pem = "-----BEGIN RSA PRIVATE KEY-----\n" \
                  "MIIEpAIBAAKCAQEAwUUPfouVadg+qnXyYus2IM8/jyG2K0arltkK/n4B8PbJWDma" \
                  "Hc0cY0ZiQ+GlmDuav8rYjjwp/OKkMcSgFVpxeH48sIB3oghqMImmApBldlge+FvA" \
                  "HPZcYTuOdXCoAS50Mw6o/0l/KgJNF9oTwMw86Vb1KORKRM3k/7WGEv/CbGQ7tzit" \
                  "2mQooI2jI/zNnz8ZnGM5qvdc861ysBNMxXJa5PUiumbQWFH+UroJJO0Ejs/hqw87" \
                  "6DqSmQj8D4Wn+XroiXBGu/Uzz4TCXNYJ2R8uFhVykm1s7fiiv84LXCbAa/Qp5sU9" \
                  "r045B5U+td5ckufSyt6LWJgj6q5fReYv7l441QIDAQABAoIBACsutgaNQ4YRtfa6" \
                  "Qb0OVtq/07C0VJKYyK/8sLMqDl77lQMsY53y/TvFNyF5ollAQBRIS1iEYtFJBmzE" \
                  "RQxgV+gXNJIvMgu3G5ratofuIW1uxQSy41rVRNDI0My2riMNcRMTXHklv87wEq+Y" \
                  "nz89owJz1nUbhOiYpGjp8xn9oUA8RRexSyvbLEMbZLI9uMh8r8bIbfwdYWNjaII2" \
                  "mCvPScWUPG2p3uXrHeQUpf01F1h/d8fQgaaehvYdo+hgra70JgRehSDruMWNzfDr" \
                  "bW7Me81xjb5t9h/gy0C7lFlD4O2dZgRLqwHnVQPfLC2xAiS4i2WYZ4uC3Fi0GD/w" \
                  "cpHsNGUCgYEA9syEb6GD6VsmKILAdaXGwA19/egOmoawPSJebXncaSDOaa85lHGS" \
                  "yc26/kcJKEBZ/4HCibDrQiB6hilhSYisphpe2vCEjj1hlbBEa455EF6zAqAW4KV0" \
                  "fYfiZ+xWLRDRyVGSJEAOfV6ct7IMPPTq2XudRrh84TR6QcuW3BfVuCMCgYEAyHmn" \
                  "YMzp9yrWIX3cXOamhGZ0SArPNVgMXljxF/egIG4VYTrCcIK6UDVwts/rgiM6mDRP" \
                  "B9ykIWngwGAOervzFCXgN0TO1O1D0to+rIk9Fi67qn8mO8Kv5wXnvQRKtO6Gk9AI" \
                  "2xBG1RyC1SXSTRysdrYBLIAtBoswMyfiS86VHqcCgYAEX0ElXR4iHyxA4XgZXXN0" \
                  "6YhG3DqOAD7VBmvX0qXV8u/VLXZ+q7hm/M8IPCfsX594iEry94BjboHdKJSBofs1" \
                  "AhiWFlay0mGNLk83/JEmehb/v+hH2IaExsh7ANPR/o9I2roVDFF1ZRyvoGbZGZmj" \
                  "eq4hl5kWwEA+NCYbBg0SMwKBgQC45Vq2MMfoqp1rrkU7eY9Ctauxdia9sENYEPfr" \
                  "fvs0bdNSJXuHgUqNB3y5XvJ6yDsWfcgWHC1Uk+4x/2XbVNVQU86DqvaH83yGT7tW" \
                  "Lg0lFF0JVtPQcjMCA7RD5F1ymjuMwGYqhMyPaQhRxdw8OqHlqt9SR7U/P8hopfRU" \
                  "rmdiKQKBgQDyuaRJyA+s1ky4U0DHsPNKviRFyw7CbCOk2rOFy5BBJj50SB+pg7WV" \
                  "eOokHf1vhkvD01oBUGM/h2oFFTZqM6FuWtUpNVY0OOVZZYzq6lOu6/th5dLet2bF" \
                  "yausy06uaeDZ4clcE1ZyIZWj0F0H2l5UmzbFzoPVHXWPER+71Ih4kA==\n" \
                  "-----END RSA PRIVATE KEY-----"
kid = 'TyQHKDRwiXnM9Tng7PwF88KbVZQ'
tpp_id = 'oCwoLzW6kqCNuzlYzW'
ss_id = '1JcSk8hDlvXIONWYB4IbdS'
client_scopes = 'ASPSPReadAccess TPPReadAccess'
token_url = 'https://auth.mit.openbanking.qa/as/token.oauth2'
ssa_url = 'https://ssaapi.mit.openbanking.qa/api/v1rc2'
aspsp_list_url = 'https://api.mit.openbanking.qa/scim/v2/OBAccountPaymentServiceProviders'

cache.set('kid', kid, timeout=CACHE_TIMEOUT)
cache.set('tpp_id', tpp_id, timeout=CACHE_TIMEOUT)
cache.set('software_statement_id', ss_id, timeout=CACHE_TIMEOUT)
cache.set('client_scopes', client_scopes, timeout=CACHE_TIMEOUT)
cache.set('token_url', token_url, timeout=CACHE_TIMEOUT)
cache.set('private_key_pem', private_key_pem, timeout=CACHE_TIMEOUT)
cache.set('tpp_ssa_url', ssa_url, timeout=CACHE_TIMEOUT)
cache.set('aspsp_list_url', aspsp_list_url, timeout=CACHE_TIMEOUT)
